...
<div style="display: flex; flex-direction: column; height: 100vh; overflow: hidden;">
	...
	<div style="display: flex; flex: 1; overflow: hidden; position: relative;">
		...
		>
			...
			>
				<svg
					...
					style="transform: rotate({sidebarCollapsed
						? '180deg'
						: '0deg'}); transition: transform var(--duration-micro) var(--ease-out);"
				>
			...
			<div class="nd-sidebar-group">
				<span
					class="nd-label nd-sidebar-section-label"
					style="padding: var(--space-sm) var(--space-md); font-size: var(--caption); color: var(--nd-text-disabled);"
					>REPORTS</span
				>
				...
				<a
					href="/config-audit"
					class="nd-sidebar-item"
					class:active={isActive('/config-audit')}
					title="Config Audit"
				>
					<svg
						width="16"
				...
				<a
					href="/infrastructure"
					class="nd-sidebar-item"
					class:active={isActive('/infrastructure')}
		...
		<!-- Main Content -->
		<main
			class="nd-scrollbar nd-main-content"
			style="flex: 1; overflow: auto; padding: var(--space-md);"
		>
			{#if loading}
				<div
					style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; color: var(--nd-text-secondary);"
				>
