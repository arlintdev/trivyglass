...
<P class="mb-4 text-lg dark:text-gray-400 sm:px-16 lg:text-xl xl:px-48">
...
<P class="mb-6 text-lg dark:text-gray-400 sm:px-16 lg:text-xl xl:px-48">
	Streamline your vulnerability management by visualizing critical security insights and remediation steps in one centralized location.
</P>
